...
var (
	...
	teepSuccessESP256 = []byte{
		...
		,
	}
	teepErrorESP256 = []byte{
		,
	}
)
...
func TestTAMEnsureDefaultTEEPAgent_Dummy_OK(t *testing.T) {
	...
	expected := []byte{
		0x81, 0x82, 0x58, 0x20, 0x64, 0x75, 0x6d, 0x6d, 0x79, 0x2d, 0x74, 0x65,
		0x65, 0x70, 0x2d, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x2d, 0x6b, 0x69, 0x64,
		0x2d, 0x66, 0x6f, 0x72, 0x2d, 0x64, 0x65, 0x76, 0x2d, 0x31, 0x32, 0x33,
		0xa2, 0x01, 0xa1, 0x19, 0x01, 0x00, 0x51, 0x01, 0x62, 0x75, 0x69, 0x6c,
		0x64, 0x69, 0x6e, 0x67, 0x2d, 0x64, 0x65, 0x76, 0x2d, 0x31, 0x32, 0x33,
		0x02, 0x82, 0x82, 0x4b, 0x81, 0x49, 0x61, 0x70, 0x70, 0x31, 0x2e, 0x77,
		0x61, 0x73, 0x6d, 0x03, 0x82, 0x4b, 0x81, 0x49, 0x61, 0x70, 0x70, 0x32,
		0x2e, 0x77, 0x61, 0x73, 0x6d, 0x02,
	}
