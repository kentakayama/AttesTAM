...
func TestTAMEnsureDefaultTEEPAgent_Dummy_OK(t *testing.T) {
	...
	assert.Equal(t, 1, len(agentStatus.SuitManifests))
	var record AgentStatusRecord
	err = record.FromModel(agentStatus)
	require.Nil(t, err)

	expected := []byte{
		0x81, 0x82, 0x58, 0x20, 0x76, 0xE9, 0xA6, 0xCB, 0xEB, 0x5E, 0x7A, 0x9F, 0x9A, 0x81, 0xE9, 0xED,
		...
		0x64, 0x69, 0x6E, 0x67, 0x2D, 0x64, 0x65, 0x76, 0x2D, 0x31, 0x32, 0x33, 0x02, 0x81, 0x82, 0x4B,
		0x81, 0x49, 0x68, 0x65, 0x6C, 0x6C, 0x6F, 0x2E, 0x74, 0x78, 0x74, 0x00,
	}
