...
func TestTEEPMessage_RoundTrip_QueryRequest_OK(t *testing.T) {
	...
	encodedQueryRequest := []byte{
		0x85, 0x01, 0xa2, 0x03, 0x81, 0x00, 0x13, 0x50, 0xa0, 0xa1, 0xa2, 0xa3, 0xa4, 0xa5, 0xa6, 0xa7,
...
func TestTEEPMessage_RoundTrip_QueryResponse_OK(t *testing.T) {
	...
	encodedQueryResponse := []byte{
		0x82, 0x02, 0xa3, 0x05, 0x00, 0x07, 0x81, 0xa2, 0x00, 0x81, 0x4f, 0x01, 0x02, 0x03, 0x04, 0x05,
		...
		0x09, 0x13, 0x50, 0xa0, 0xa1, 0xa2, 0xa3, 0xa4, 0xa5, 0xa6, 0xa7, 0xa8, 0xa9, 0xaa, 0xab, 0xac,
		0xad, 0xae, 0xaf,
	}
...
func TestTEEPMessage_RoundTrip_Update_OK(t *testing.T) {
	...
	// ]
	encodedUpdate := []byte{
		0x82, 0x03, 0xa2, 0x09, 0x81, 0x59, 0x01, 0x4e, 0xa2, 0x02, 0x58, 0x73, 0x82, 0x58, 0x24, 0x82,
		...
		0x74, 0x61, 0x15, 0x0f, 0x03, 0x0f, 0x13, 0x50, 0xa0, 0xa1, 0xa2, 0xa3, 0xa4, 0xa5, 0xa6, 0xa7,
...
func TestTEEPMessage_RoundTrip_Success_OK(t *testing.T) {
	...
	*/
	encodedSuccess := []byte{
		0x82, 0x04, 0xa2, 0x12, 0x81, 0x58, 0x64, 0xa3, 0x18, 0x63, 0x82, 0x60,
		0x82, 0x2f, 0x58, 0x20, 0x66, 0x58, 0xea, 0x56, 0x02, 0x62, 0x69, 0x6d,
		0xd1, 0xf1, 0x3b, 0x78, 0x22, 0x39, 0xa0, 0x64, 0xda, 0x7c, 0x6c, 0x5c,
		0xba, 0xf5, 0x2f, 0xde, 0xd4, 0x28, 0xa6, 0xfc, 0x83, 0xc7, 0xe5, 0xaf,
		0x03, 0x81, 0xa3, 0x00, 0x81, 0x48, 0x61, 0x70, 0x70, 0x2e, 0x77, 0x61,
		0x73, 0x6d, 0x0e, 0x19, 0xfe, 0x6c, 0x03, 0x58, 0x24, 0x82, 0x2f, 0x58,
		0x20, 0x21, 0xd2, 0xe4, 0xb1, 0x9e, 0x44, 0xc1, 0x90, 0x6e, 0x58, 0x05,
		0x05, 0x77, 0x92, 0x2d, 0x60, 0x4c, 0x20, 0x4c, 0xcc, 0x2f, 0xd2, 0xcb,
		0x97, 0x7f, 0xee, 0x8e, 0xd5, 0x6b, 0x62, 0xfd, 0x36, 0x04, 0xf5, 0x13,
		0x48, 0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77,
	}
...
func TestTEEPMessage_RoundTrip_Error_OK(t *testing.T) {
	...
	*/
	encodedError := []byte{
		,
	}
...
func TestTEEPMessage_AgentQueryResponse(t *testing.T) {
	encodedQueryResponse := []byte{
		0x82, 0x02, 0xA2, 0x06, 0x59, 0x02, 0x23, 0xD2, 0x84, 0x43, 0xA1, 0x01, 0x26, 0xA0, 0x59, 0x01,
		...
		0xFF, 0xCA, 0xA3, 0x6C, 0x8F, 0xBD, 0x25, 0xA4, 0xC5, 0x3F, 0x0D, 0x81, 0xA1, 0x0F, 0x81, 0x48,
